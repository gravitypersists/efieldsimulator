...
(function() {
  ...
  Arrow = (function() {
    ...
    Arrow.prototype.makeLine = function() {
      ...
      _.map(attrs, function(v, k) {
        return _this.line.setAttribute(k, v);
      });
      return this.line;
    };

    Arrow.prototype.setVector = function(angle) {
      this.angle = angle;
      return this.line.setAttribute("transform", "rotate(" + this.angle + ", " + this.x + ", " + this.y + ")");
    };

    Arrow.prototype.opacity = function(opacity) {
      return this.line.setAttribute("opacity", opacity);
    };
  ...
  Charge = (function() {
    function Charge(x, y, coulombs) {
      this.x = x;
      this.y = y;
      this.coulombs = coulombs != null ? coulombs : 1;
    }
  ...
  EField = (function() {
    ...
    EField.prototype.drawArrows = function() {
      ...
      for (i = _i = 1; 1 <= m ? _i <= m : _i >= m; i = 1 <= m ? ++_i : --_i) {
        for (j = _j = 1; 1 <= n ? _j <= n : _j >= n; j = 1 <= n ? ++_j : --_j) {
          ...
          this.bglayer.append(arrow.makeLine());
    ...
    EField.prototype.addStationaryCharge = function(x, y) {
      var circle;
      ...
      return this.toplayer.append(circle);
    };
    ...
    EField.prototype._updateArrows = function() {
      ...
      return _.each(this.arrows, function(arrow) {
        ...
        return arrow.opacity(magnitude);
      });
    };
